...
export default function LoginScreen({ navigation }) {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            console.error("Erro ao fazer login:", error.response?.data?.error || error.message || "Erro desconhecido");
            Alert.alert("Erro ao fazer login", error.response?.data?.error || error.message || "Erro desconhecido");
        }
    };
